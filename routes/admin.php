...
Route::get('/addcompany', 'Admin\HomeController@addcompany');
Route::post('/newcompany', 'Admin\HomeController@newcompany');
Route::get('/listcompany', 'Admin\HomeController@listcompany');
Route::get('/delcompany/{id}', 'Admin\HomeController@delcompany');
Route::get('/listuser', 'Admin\HomeController@listuser');
Route::get('/deluser/{id}', 'Admin\HomeController@deluser');
Route::get('/listinvoice', 'Admin\HomeController@listinvoice');
Route::get('/delinvoice/{id}', 'Admin\HomeController@delinvoice');