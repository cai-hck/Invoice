...
<section id="main">
    <article class="article" id="new_invoice">
        <div class="new-invoice">
            <h4>اصدار فاتورة تسديد المصادر</h4>
            <div class="new-invoice-inner">
                <div class="invoice-form" style="padding:60px;">
                    <form method="POST" action="{{url('newpaying')}}"  id="invoice_form" name="invoice_form" class="" id="paid_form">
                        @csrf
                        ...
                        <div class="input-group form-group" style="display:none;">
                            ...
                            <div class="input-group-prepend ">
                                ...
                                <input type="number" name="total" aria-label="Total" class="form-control" value="0" min="0" id="paid_money" >
                            </div>
                        </div>
...
<script>
    ...
    $('#invoice_form').submit(function(){
        ...
        {
            setTimeout(function() { window.location = $('#addpaying_a').prop('href'); }, 3000);
        }
        return true;
    })
