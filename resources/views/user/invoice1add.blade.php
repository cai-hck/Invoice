...
<section id="main">
    <article class="article" id="new_invoice">
        <div class="new-invoice">
            <h4>اصدار فاتورة شركات</h4>
            <div class="new-invoice-inner">
                <div class="invoice-form">
                    <form method="POST" action="{{url('newinvoice1')}}" name="invoice_form" class="" id="invoice_form">
                        @csrf
...
<script>
    ...
    $('#invoice_form').submit(function(){
        ...
        {
            setTimeout(function() { window.location = $('#addinvoice1_a').prop('href'); }, 3000);
        }
        return true;
    })
