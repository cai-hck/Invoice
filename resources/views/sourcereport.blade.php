...
<section id="main" class="float-left w-100">
    <article class="article" id="source_report">
        <h3 class="tab-content-title  bg-primary text-white">كشف المصادر</h3>
        <div class="header-form">
            <div class="header-form_inner float-left w-100">
                <form action="{{url('find')}}" method="POST">
                    @csrf
                    <input type="hidden" value="sourcereport" name="type">
        ...
        <div class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$invoice['et']}}</td>
                    <td>{{$invoice['adult_no']*$invoice['adult_buy'] +$invoice['child_no']*$invoice['child_buy'] + $invoice['infant_no']*$invoice['infant_buy'] - (($invoice['adult_no']*$invoice['adult_fair'] +$invoice['child_no']*$invoice['child_fair'] + $invoice['infant_no']*$invoice['infant_fair'])*$invoice['comission_source'])}}</td>
