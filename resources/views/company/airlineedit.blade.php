        ...
        <div class="new-invoice">
            ...
            <div class="new-invoice-inner">
                <div class="invoice-form">
                    <form  action="{{url('updateairline')}}" method="POST" enctype="multipart/form-data" name="invoice_form" class="" id="invoice_form" >
                        @csrf
                        ...
                        <div class="input-group form-group">
                            ...
                            <div class="input-group-prepend ">
                                ...
                                <input type="text" name="name" aria-label="Name" class="form-control" placeholder="" required  value="{{$airline->name}}">
                            </div>
                        </div>
