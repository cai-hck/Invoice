...
<div class="vertical-navigations animated">
    <ul class="side-nav fixed animated collapsible collapsible-accordion" id="nav-default">
        ...
        <li>
            <a class="collapsible-header no-col-body waves-effect waves-set" href="{{ url('/admin/addcompany') }}">
                <i class="material-icons">dashboard</i>
                <span>Add Company</span>
            </a>
        </li>
        <li>
            <a class="collapsible-header no-col-body waves-effect waves-set" href="{{ url('/admin/listcompany') }}">
                <i class="material-icons">dashboard</i>
                <span>Companies</span>
            </a>
        </li>
        <li>
            <a class="collapsible-header no-col-body waves-effect waves-set" href="{{ url('/admin/listuser') }}">
                <i class="material-icons">dashboard</i>
                <span>Users</span>
            </a>
        </li>
        <li>
            <a class="collapsible-header no-col-body waves-effect waves-set" href="{{ url('/admin/listinvoice') }}">
                <i class="material-icons">dashboard</i>
                <span>Invoices</span>
            </a>
        </li>
