        ...
        <div class="new-invoice">
            ...
            <div class="new-invoice-inner">
                <div class="invoice-form">
                    <form method="POST" action="{{url('updateinvoice')}}" name="invoice_form" class="" id="invoice_form">
                        @csrf
                        ...
                        <div class="input-group form-group d-flex date-no">
                            ...
                            <div class="invoice-source-comission invoice-no d-flex">
                        ...
                        <div class="input-group form-group">
                            ...
                            <div class="input-group-prepend ">
                                ...
                                <input type="number" name="to_pay" value="{{$invoice->to_pay}}" aria-label="To pay" class="form-control" placeholder="المبلغ" >
                            </div>
                        </div>
                        <div class="input-group form-group">
