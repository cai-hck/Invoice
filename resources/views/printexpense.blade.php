        ...
        <tbody>
            <tr>
                ...
                <td style=" text-align:left;  width:30%;">
                    ...
                    <span style="font-size: 20px;font-weight:bold;color:#6F6F6F;">{{$expense->id}}</span>
                </td>
            </tr>
        </tbody>
    </table>
        ...
        <tbody>
            <tr>
                <td style="width:50%;">
                    ...
                    <br/> 
                    <span style="font-size:16px;">{{$expense->name}}</span>
                </td>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <span style="font-size:16px;">{{$expense->note}}</span>
                </td>
            </tr>
        </tbody>
    </table>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <br/>
                    <span style="font-size:16px;">{{$expense->cost}}</span>
                </td>
            </tr>
        </tbody>
    </table>
