        ...
        <div class="new-invoice">
            ...
            <div class="new-invoice-inner">
                <div class="invoice-form" style="padding:60px;">
                    <form method="POST"  id="invoice_form" action="{{url('updatepaid')}}" name="invoice_form" class="" id="paid_form">
                        @csrf
                        <input type="hidden" value="{{$paid->id}}" name="id">
                        <div class="input-group form-group">
                            <div class="invoice-name invoice-no">
                            <div class="input-group-prepend ">
                                <span class="input-group-text">رقم الوصل</span>
                                </div>
                                <input type="number" name="invoice_nu" aria-label="Invoice_nu" class="form-control" min="0" required  value="{{$paid->invoice_nu}}" >
                            </div>
                        </div>
                        <div class="input-group form-group">
                            <div class="invoice-name invoice-no">
                            <div class="input-group-prepend ">
                                ...
                                <input type="number" name="amount" aria-label="Total" class="form-control"  min="0" value="{{$paid->amount}}">
                            </div>
                        </div>
                        <div class="input-group form-group">
                            <div class="invoice-name invoice-no">
                            <div class="input-group-prepend ">
                                ...
                                <option value="{{$paid->u_company_id}}">{{$paid->ucompany}} </option>
                        ...
                        <div class="input-group form-group">
                            ...
                            <div class="input-group-prepend ">
                                ...
                                <input type="text" name="details"aria-label="Details" class="form-control" placeholder="" value="{{$paid->details}}">
                            </div>
                        </div>
                        <div class="input-group form-group" style="display:none;">
                            ...
                            <div class="input-group-prepend ">
                                ...
                                <input type="number" name="total" aria-label="Total" class="form-control" min="0" id="paid_money" value="{{$paid->total}}">
                            </div>
                        </div>
                        ...
                        <div class="input-group form-group" style="display:none;">
                            ...
                            <div class="input-group-prepend ">
                                ...
                                <input type="number" aria-label="Returned Passenger Balance" class="form-control" name="returned_balance_to_passenger" value="{{$paid->returned_balance_to_passenger}}">
                            </div>
                        </div>
                        <div class="input-group form-group">
                            <div class="returned-balance invoice-no">
                            <div class="input-group-prepend ">
                                <span class="input-group-text">استرجاع الرصيد الى الشركات</span>
                                </div>
                                <input type="number" aria-label="Returned Balance from Source" class="form-control" name="returned_balance_from_source" value="{{$paid->returned_balance_from_source}}">
                            </div>
                        </div>
